...
description: |
 This is a project that applies newest machine learning techniques to PISA data in order to discover the reading scores predictors for boys and girls
authors: 
...
```{r table1, eval = TRUE, echo = FALSE, out.width = '100%', fig.cap = "Overview of variables"}
